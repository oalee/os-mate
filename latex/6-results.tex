...
% \footnote{The current limitation is anticipated to be mitigated in forthcoming versions through the implementation of an engineering solution that utilizes a repository of GitHub projects and their respective dependencies.} 
...
% \subsection{Export of Metadata}

% Yerbamate also exports metadata about the exported modules, such as links to the code as a table. This metadata provides greater visibility into the data processing pipeline, making it easier to track the processing of data throughout the project. By providing access to this metadata, the Yerbamate framework enables users to understand how their data is being processed, making it easier to reproduce results and improve the transparency of their work.
